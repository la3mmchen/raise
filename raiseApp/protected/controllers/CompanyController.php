...
class CompanyController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Company']))
		{
			...
			if($model->save()) {
				$this->associateCompanyToBranch(array("uncategorized" =>$model->company_id));
	...
	/**
	 * Assigns a Businessbranch to a Company
	 */
	...
	/**
	 * Makes an association between a company and a business branch
	 */
	public function associateCompanyToBranch($array)
	{
		...
		$sql = "INSERT INTO tbl_company2businessbranch (company2businessbranch_companyId, company2businessbranch_businessbranchId) VALUES (".$compId.", ".$branId->businessbranch_id.")";
